...
public class CustomAttribute {
    ...
    public static final RegistryObject<Attribute> ATTACK_KNOCKBACK = ATTRIBUTES.register("attack_knockback", () -> (Attribute) new RangedAttribute("attribute.mod.attack_knockback", 5.0D, 0.0D, 1024.0D).setSyncable(true));
