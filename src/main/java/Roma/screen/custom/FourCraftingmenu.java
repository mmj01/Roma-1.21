...
public class FourCraftingmenu extends AbstractContainerMenu {
    ...
    public FourCraftingmenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        // Add input slots: 4x4 grid (slots 1–16)
        int index = 1;
        int gridStartX = 29;  // updated
        int gridStartY = 26;
...
// Add output slot (slot 0)
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 146, 54));
    ...
    private void addPlayerInventory(Inventory playerInventory) {
        int startX = 8;
        int startY = 122;  // aligned with texture
