...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, COPPER_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_COPPER_ORE_KEY),
                ModOrePlacement.commonOrePlacement(17,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-200), VerticalAnchor.absolute(150))));
